...
<!-- PRESENTATION Hébergeur ============================================================== -->
  <section><h2>Informations sur mon hébergeur</h2>
           <p><strong>Nom : </strong> InfinityFree</p>
           <p><strong>Logo : </strong> <img src="img/infinityfree.jpg" /></p>
           <p><strong>Siège social : </strong> Bulman House, Regent Centre, Gosforth, Newcastle upon Tyne, NE3 3LS</p>
